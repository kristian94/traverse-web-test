...
//                var degEnd = 45;
                ...
                $(toggle).on('click', function () {
                    ...
                    if (direction == 'out') {
                        $('.top-container-menu').show();
                        transX = Number(-$('.top-container-menu-and-overflow').width() * 0.25 + 16) + 'px';
                        targetOpacity = 1;
                    } else {
                        
                        transX = 0;
//                        transX = Number($('.top-container-menu-and-overflow').width() * 0.25) + 'px';
                        targetOpacity = 0;
                    }
                    ...
                    $(menu).css('opacity', targetOpacity);
